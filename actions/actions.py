...
class ActionUnitWise_Madh(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        for d in data:
            if d["branch"] == Madh:
                message=dispatcher.utter_message("Hey,Here are the results "+"Location:"+d["branch"]+ ",Target:" + str(d["target"])+ ",Achieved:"+str(d["achieved"])+",Last Month Achieved:"+str(d["asondate"])+",Achieved Percentage:"+str(d["achievedpercentage"]))
                return []
...
class ActionUnitsMonth(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        year = datestr.year
        month = datestr.month
        final_date = last_day_of_month(datetime.date(year, month-1, 1))
        print(final_date)
...
class ActionUnitWiseMadhapur_admission(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        for d in m:
            if d["branch"]==MAdh:
                message=dispatcher.utter_message("Hey Boss,Here are the results "+"Location:"+d["branch"]+ ",target:" + d["plan"]+ ",achieved" + d["adm"]+ ",Achieved Percentage:"+d["ach"]+",mtd:"+d["mtd"]+",Gap:"+d["gap"])
                return []
...
class Actionvizaga(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict) -> List[EventType]:
        buttons=[
            ...
            {"payload": "W&C_adm", "title": "Vizag W&C"}
        ]
        dispatcher.utter_message("Vizag Cluster",buttons=buttons)
        return []
...
class ActionUnitTargetadm(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        for d in m:
            if d["branch"]==units:
                message=dispatcher.utter_message("Hey Boss,Here are the results "+"Location:"+d["branch"]+ ",Target:" + d["plan"]+ ",Achieved:"+d["adm"]+",Last Month Achieved:"+d["mtd"]+",Achieved Percentage:"+d["ach"]+",Gap:"+d["gap"])
                return []
class ActionUnitWiseNellore_admission_month(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher, tracker: Tracker, domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        ...
        for d in m:
            if d["branch"]==unit:
                message=dispatcher.utter_message("Hey,Here are the results "+"Location:"+d["branch"]+ ",target:" + d["plan"]+ ",achieved" + d["adm"]+ ",Achieved Percentage:"+d["ach"]+",mtd:"+d["mtd"]+",Gap:"+d["gap"])
                return []
